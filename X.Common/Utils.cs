...
namespace X.Common
{
    public class Utils
    {
        ...
        private static DateTime defaultDTBegin = new DateTime(1970, 1, 1);

        /// <summary>
        /// 获取时间间隔（秒）。默认开始时间 1970-1-1
        /// </summary>
        /// <returns></returns>
        public static long GetElapsedSpanTotalMilliseconds()
        {
            return GetElapsedSpanTotalMilliseconds(defaultDTBegin, DateTime.Now);
        }
        ...
        /// <returns></returns>
        public static long GetElapsedSpanTotalMilliseconds(DateTime dtBegin)
        {
            return GetElapsedSpanTotalMilliseconds(dtBegin, DateTime.Now);
        }
        ...
        /// <returns></returns>
        public static long GetElapsedSpanTotalMilliseconds(DateTime dtBegin, DateTime dtEnd)
        {
            long elapsedTicks = dtEnd.Ticks - dtBegin.Ticks;
        ...
        public static String SubStringHTML(String param, int length, String end)
        {
            ...
            if (GetStringLength(param.ToString()) > length)
                result.Append(end);
